...
//	    		img1.setImage(new Image("file:/Users/neal/eclipse-workspace-java/Scrabble_Graphique/resources/Wood/letter_" + m.getMainJoueur().get(0).toString() + ".png"));
//	    		Img2.setImage(new Image("file:/Users/neal/eclipse-workspace-java/Scrabble_Graphique/resources/Wood/letter_" + m.getMainJoueur().get(1).toString() + ".png"));
//	    		Img3.setImage(new Image("file:/Users/neal/eclipse-workspace-java/Scrabble_Graphique/resources/Wood/letter_" + m.getMainJoueur().get(2).toString() + ".png"));
//	    		Img4.setImage(new Image("file:/Users/neal/eclipse-workspace-java/Scrabble_Graphique/resources/Wood/letter_" + m.getMainJoueur().get(3).toString() + ".png"));
//	    		Img5.setImage(new Image("file:/Users/neal/eclipse-workspace-java/Scrabble_Graphique/resources/Wood/letter_" + m.getMainJoueur().get(4).toString() + ".png"));
//	    		Img6.setImage(new Image("file:/Users/neal/eclipse-workspace-java/Scrabble_Graphique/resources/Wood/letter_" + m.getMainJoueur().get(5).toString() + ".png"));
//	    		Img7.setImage(new Image("file:/Users/neal/eclipse-workspace-java/Scrabble_Graphique/resources/Wood/letter_" + m.getMainJoueur().get(6).toString() + ".png"));
//	    		
